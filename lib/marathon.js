export const OPEN_CATEGORY_FEE_PAISE = 0;
export const OPEN_CATEGORY_FEE_RUPEES = 0;
// Open categories are now free — keeping the array empty so isPaidCategory always returns false
export const PAID_CATEGORY_CODES = [];
